...
export const setLastUpdatedAuditDetails = (techRecord: TechRecordType<'get'>, createdByName: string, createdById: string, date: string, statusCode: StatusCode): TechRecordType<'get'> => {
...
export const setCreatedAuditDetails = (techRecord: TechRecordType<'get'>, createdByName: string, createdById: string, date: string, statusCode: StatusCode): TechRecordType<'get'> => {
